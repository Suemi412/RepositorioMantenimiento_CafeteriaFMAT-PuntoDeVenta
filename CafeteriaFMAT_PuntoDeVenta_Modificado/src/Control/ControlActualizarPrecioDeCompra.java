...
public class ControlActualizarPrecioDeCompra implements ActionListener {
    ...
    public ControlActualizarPrecioDeCompra(Producto modeloProducto, vistaActualizarPrecioDeCompra vistaActual,
        ...
        this.vistaActualizarPrecioDeCompra.getTxtPrecioActual()
                .setText(String.valueOf(modeloProducto.getPrecioDeCompra()));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (vistaActualizarPrecioDeCompra.getBotonActualizar() == e.getSource()) {
            try {
                ...
                modeloProducto.setPrecioDeCompra(
                        Double.valueOf(this.vistaActualizarPrecioDeCompra.getTxtModificacion().getText()));

                daoProducto.modificar(modeloProducto, condicion);
                this.v.setEnabled(true);
                vistaActualizarPrecioDeCompra.dispose();
            } catch (NumberFormatException error) {
                JOptionPane.showMessageDialog(this.vistaActualizarPrecioDeCompra, "Valor invalido", "Error",
                        JOptionPane.ERROR_MESSAGE);
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this.vistaActualizarPrecioDeCompra, "Error en la base de datos", "Error",
                        JOptionPane.ERROR_MESSAGE);
