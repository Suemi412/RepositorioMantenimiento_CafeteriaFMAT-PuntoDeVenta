...
public class ControlAbrirCorte implements ActionListener {
    ...
    private DateTimeFormatter dtfDay = DateTimeFormatter.ofPattern("dd");
    private DateTimeFormatter dtfMonth = DateTimeFormatter.ofPattern("MM");
    ...
    public ControlAbrirCorte(Dia modeloDia, pantallaPrincipal v, vistaAbrirCorte vistaActual) {
        ...
        this.vistaAbrirCorte.getTextoDia().setText(dtfDay.format(now));
        this.vistaAbrirCorte.getTextoMes().setText(dtfMonth.format(now));
        this.vistaAbrirCorte.getTextoAnio().setText(dtfYear.format(now));
    }
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (vistaAbrirCorte.getBotonAbrirCorte() == evento.getSource()) {
            ...
            try {
                ...
                if (dia > 31) {
                    JOptionPane.showMessageDialog(this.vistaAbrirCorte, "Día fuera de rango", "Error",
                            JOptionPane.ERROR_MESSAGE);
                } else {
                    if (mes > 12) {
                        JOptionPane.showMessageDialog(this.vistaAbrirCorte, "Mes fuera de rango", "Error",
                                JOptionPane.ERROR_MESSAGE);
                    } else {
                        if (anio < 1000 || anio > 3000) {
                            JOptionPane.showMessageDialog(this.vistaAbrirCorte, "Año fuera de rango", "Error",
                                    JOptionPane.ERROR_MESSAGE);
                        } else {
                ...
                JOptionPane.showMessageDialog(this.vistaAbrirCorte, "Fecha invalida", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }
