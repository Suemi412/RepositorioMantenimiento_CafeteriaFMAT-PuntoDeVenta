    ...
    public void actionPerformed(ActionEvent evento) {
        if (vistaAgregarArea.getBotonCrearArea() == evento.getSource()) {
            ...
            try {
                ...
                this.vistaAgregarArea.getTextoCodigoArea()
                        .setText(String.valueOf(Integer.valueOf(vistaAgregarArea.getTextoCodigoArea().getText())));
            }
        ...
        if (vistaAgregarArea.getBotonAgregarClasificacion() == evento.getSource()) {
            ...
            ControlAgregarClasificacion c = new ControlAgregarClasificacion(a, clas, vistaClas, this.vistaAgregarArea,
                    this.v);
