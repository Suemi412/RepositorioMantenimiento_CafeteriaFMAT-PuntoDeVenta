...
public class ControlBuscarProducto implements ActionListener {
    ...
    public ControlBuscarProducto(Producto modeloProducto, pantallaPrincipal v, vistaBuscadorInventario vistaActual) {
        ...
        this.vistaBuscadorInventario.getTextoDescripcionProducto().setEditable(false);
        ...
        this.vistaBuscadorInventario.getTextoCodigoClasificacion()
                .setText(String.valueOf(modeloClasificacion.getCodigo()));
        ...
        this.vistaBuscadorInventario.getTextoDescripcionProducto().setText(modeloProducto.getDescripcion());
    ...
    public void actionPerformed(ActionEvent evento) {
        ...
        if (vistaBuscadorInventario.getBotonEliminarProductoDelInventario() == evento.getSource()) {
            int opcion = JOptionPane.showConfirmDialog(this.vistaBuscadorInventario,
                    "El producto será eliminado del inventario y no podrá ser recuperado", "Advertencia",
        ...
        if (vistaBuscadorInventario.getBotonBuscar() == evento.getSource()) {
            try {
                ...
                try {
                    ...
                    this.vistaBuscadorInventario.getTextoExistencias()
                            .setText(String.valueOf(producto.getExistencia()));
                    ...
                    this.vistaBuscadorInventario.getTextoDescripcionProducto().setText(producto.getDescripcion());
                } catch (SQLException e) {
                    e.printStackTrace();
                }

            } catch (NumberFormatException error) {
                JOptionPane.showMessageDialog(this.vistaBuscadorInventario, "Valor de codigo invalido", "Error",
        ...
        if (vistaBuscadorInventario.getBotonActualizarPrecioDeLaCompra() == evento.getSource()) {
            ...
            try {
                ...
                ControlActualizarPrecioDeCompra cAPDC = new ControlActualizarPrecioDeCompra(modeloProducto, vAPDC,
                        vistaBuscadorInventario);
        ...
        if (vistaBuscadorInventario.getBotonActualizarPrecioDeVenta() == evento.getSource()) {
            ...
            try {
                ...
                ControlActualizarPrecioDeVenta cAPDV = new ControlActualizarPrecioDeVenta(modeloProducto, vAPDV,
                        vistaBuscadorInventario);
        ...
        if (vistaBuscadorInventario.getBotonActualizarExistencias() == evento.getSource()) {
            ...
            try {
                ...
                ControlActualizarExistencias cAPDV = new ControlActualizarExistencias(modeloProducto, vAE,
                        vistaBuscadorInventario);
                vAE.setVisible(true);
            } catch (Exception e) {
                JOptionPane.showMessageDialog(this.vistaBuscadorInventario, "Favor de ingresar un codigo Valido");
