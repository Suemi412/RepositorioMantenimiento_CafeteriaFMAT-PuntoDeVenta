...
public class ControlActualizarPrecioDeVenta implements ActionListener {
    ...
    public ControlActualizarPrecioDeVenta(Producto modeloProducto, vistaActualizarPrecioDeVenta vistaActual,
        ...
        this.vistaActualizarPrecioDeVenta.getTxtPrecioActual()
                .setText(String.valueOf(modeloProducto.getPrecioDeVenta()));
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (vistaActualizarPrecioDeVenta.getBotonActualizar() == e.getSource()) {
            ...
            try {
                ...
                modeloProducto.setPrecioDeVenta(
                        Double.valueOf(this.vistaActualizarPrecioDeVenta.getTxtModificacion().getText()));
                ...
                JOptionPane.showMessageDialog(this.vistaActualizarPrecioDeVenta, "Valor invalido", "Error",
                        JOptionPane.ERROR_MESSAGE);
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(this.vistaActualizarPrecioDeVenta, "Error en la base de datos", "Error",
                        JOptionPane.ERROR_MESSAGE);
            }
